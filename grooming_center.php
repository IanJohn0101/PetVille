...
<body>
  ...
  <div class="main"> 
    ...
    <form method="POST" class="add-grooming-center-form" id="add-grooming-center-form">
      <div class="wrapper bg-white mt-sm-5">
      <h4 class="pb-4 border-bottom">Animal Grooming Center</h4>
        ...
        <div class="py-2">
          <div class="row py-2">
              <div class="col-md-6"> <label for="grooming_center">Grooming Center's Name</label> <input type="text" name = "grooming_center" class="bg-light form-control" placeholder="Grooming Center"> </div>
              <div class="col-md-6 pt-md-0 pt-3"> <label for="grooming_center_contact_number">Contact Number</label> <input type="text" name = "grooming_center_contact_number" class="bg-light form-control" placeholder="Contact Number"> </div>
          </div>
          <div class="row py-2">
              <div class="col-md-6"> <label for="grooming_center_location">Location</label> <input type="text" name = "grooming_center_location" class="bg-light form-control" placeholder="Location"> </div>
              <div class="col-md-6 pt-md-0 pt-3"> <label for="grooming_center_email">Email</label> <input type="text" name = "grooming_center_email" class="bg-light form-control" placeholder="Email"> </div>
          </div>
