<?php require_once('updateVeterinarian2.php')?>
...
<body>
  ...
  <div class="main"> 
    ...
    <div class="wrapper bg-white mt-sm-5">
      <h4 class="pb-4 border-bottom">Update Veterinarian</h4>
        <style>
          #img-section {
        ...
        <div class="py-2">
          <div class="row py-2">
              <div class="col-md-6"> <label for="vet_name">Veterinarian Name</label> <input type="text" name = "vet_name" value="<?= $result->vet_name;?>" class="bg-light form-control" placeholder="Veterinarian Name"> </div>
              <div class="col-md-6 pt-md-0 pt-3"> <label for="vet_email">Email</label> <input type="text" name = "vet_email" value="<?= $result->vet_email;?>" class="bg-light form-control" placeholder="Email"> </div>
          </div>
          <div class="row py-2">
              <div class="col-md-6"> 
                  <label for="vet_contact_number">Contact Number</label> <input type="text" name = "vet_contact_number" value="<?= $result->vet_contact_number;?>" class="bg-light form-control" placeholder="Contact Number"> 
              </div>
              <div class="col-md-6 pt-md-0 pt-3"> 
                <label for="vet_location">Location</label> <input type="text" name = "vet_location" id="vet_location" value="<?= $result->vet_location;?>" class="bg-light form-control" placeholder="Location">
              </div>
          </div>
          <div class="row py-2">
              <div class="col-md-6"> 
                  <label for="vet_img">Update your profile photo</label> 
              </div>
              <div class="col-md-6 pt-md-0 pt-3"> 
                <input type="file" name = "vet_img">
              </div>
          </div>
