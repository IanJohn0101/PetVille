<?php require_once('deleteAnimalShelter2.php')?>
...
<body>
  ...
  <div class="main"> 
    ...
    <div class="wrapper bg-white mt-sm-5">
      <h4 class="pb-4 border-bottom">Are you sure to delete this Animal Shelter?</h4>
        <style>
          #img-section {
        ...
        <div class="py-2">
          ...
          <div class="py-3 pb-4 border-bottom"> 
              <button class="btn btn-primary mr-3" name = "delete_animal_shelter" id= "delete_animal_shelter">Delete</button>
              <button class="btn border button"><a href= "viewAnimalShelter.php">Cancel</a></button> 
          </div>
