<?php require_once('deleteGroomingCenter2.php')?>
...
<body>
  ...
  <div class="main"> 
    ...
    <div class="wrapper bg-white mt-sm-5">
      <h4 class="pb-4 border-bottom">Are you sure to delete this Grooming Center?</h4>
        <style>
          #img-section {
        ...
        <div class="py-2">
          ...
          <div class="py-3 pb-4 border-bottom"> 
              <button class="btn btn-primary mr-3" name = "delete_grooming_center" id= "delete_grooming_center">Delete</button>
              <button class="btn border button"><a href= "viewGroomingCenter.php">Cancel</a></button> 
          </div>
