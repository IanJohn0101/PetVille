...
<body>
  ...
  <div class="main"> 
    ...
    <div class="wrapper bg-white mt-sm-5">
      <h4 class="pb-4 border-bottom">Update Product</h4>
        <style>
          #img-section {
        ...
        <div class="py-2">
          <div class="row py-2">
              <div class="col-md-6"> 
                  <label for="product_name">Product Name</label> <input type="text" name = "product_name" value="<?= $result->product_name;?>" class="bg-light form-control" placeholder="Username"> 
              </div>
              <div class="col-md-6 pt-md-0 pt-3"> 
                  <label for="product_brand">Product Brand</label> <input type="text" name = "product_brand" value="<?= $result->product_brand;?>" class="bg-light form-control" placeholder="Email"> 
              </div>
          </div>
          <div class="row py-2">
              <div class="col-md-6"> 
                  <label for="product_category">Product Category</label> <input type="text" name = "product_category" value="<?= $result->product_category;?>" class="bg-light form-control" placeholder="Contact Number"> 
              </div>
              <div class="col-md-6 pt-md-0 pt-3"> 
                <label for="product_price">Product Price</label> <input type="text" name = "product_price" value="<?= $result->product_price;?>" class="bg-light form-control" placeholder="Confirm Password">
              </div>
              <div class="col-md-6 pt-md-0 pt-3"> 
                <label for="product_quantity">Product Quantity</label> <input type="text" name = "product_quantity"  value="<?= $result->product_quantity;?>" class="bg-light form-control" placeholder="Confirm Password">
              </div>
          </div>
          <div class="row py-2">
              <div class="col-md-6"> 
