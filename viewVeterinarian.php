...
<body>
<?php	
	$pdo_statement = $conn->prepare("SELECT * FROM veterinarian ORDER BY id DESC");
    ...
    <div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <td><?php echo $row["vet_contact_number"]; ?></td>
								<td><?php echo $row["vet_email"]; ?></td>
                <td><?php echo $row["vet_location"]; ?></td>
								<td><a class="ajax-action-links" href='updateVeterinarian.php?id=<?php echo $row['id']; ?>'><button class="btn btn-primary mr-3" name = "edit" id= "edit">Update</button></td>
								<td><a class="ajax-action-links" href='deleteVeterinarian.php?id=<?php echo $row['id']; ?>'><button class="btn btn-danger" style="color:rgba(255, 255, 255, 255)">Delete</button></td>
							</tr>
							<?php
								}
							}
