...
<body>
  ...
  <div class="main"> 
    ...
    <form method="POST" class="add-vet-form" id="add-vet-form">
      <div class="wrapper bg-white mt-sm-5">
      <h4 class="pb-4 border-bottom">Veterinarian</h4>
        ...
        <style>
          ...
          .btn-upload {
            ...
            <div class="pl-sm-4 pl-2" id="img-section"> <b>image of the veterinarian</b>
        ...
        <div class="py-2">
          <div class="row py-2">
              <div class="col-md-6"> <label for="vetName">Name of the Veterinarian</label> <input type="text" name = "vet_name" class="bg-light form-control" placeholder="Veterinarian Name"> </div>
              <div class="col-md-6 pt-md-0 pt-3"> <label for="vet_contact_number">Contact Number</label> <input type="text" name = "vet_contact_number" class="bg-light form-control" placeholder="Contact Number"> </div>
          </div>
          <div class="row py-2">
              <div class="col-md-6"> <label for="location">Location</label> <input type="text" name = "vet_location" class="bg-light form-control" placeholder="Location"> </div>
              <div class="col-md-6 pt-md-0 pt-3"> <label for="email">Email</label> <input type="text" name = "vet_email" class="bg-light form-control" placeholder="Email"> </div>
          </div>
