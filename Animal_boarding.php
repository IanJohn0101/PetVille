...
<body>
  ...
  <div class="main"> 
    ...
    <form method="POST" class="add-animal-boarding-form" id="add-animal-boarding-form">
      ...
      <h4 class="pb-4 border-bottom">Animal Shelter</h4>
        ...
        <style>
          ...
          .btn-upload {
            ...
            <div class="pl-sm-4 pl-2" id="img-section"> <b>image of the Animal Shelter</b>
        ...
        <div class="py-2">
          <div class="row py-2">
              <div class="col-md-6"> <label for="animal_boarding_name">Animal Shelter's Name</label> <input type="text" name = "animal_boarding_name" class="bg-light form-control" placeholder="Animal Shelter's Name"> </div>
              <div class="col-md-6 pt-md-0 pt-3"> <label for="animal_boarding_contact_number">Contact Number</label> <input type="text" name = "animal_boarding_contact_number" class="bg-light form-control" placeholder="Contact Number"> </div>
          </div>
          <div class="row py-2">
              <div class="col-md-6"> <label for="animal_boarding_location">Location</label> <input type="text" name = "animal_boarding_location" class="bg-light form-control" placeholder="Location"> </div>
              <div class="col-md-6 pt-md-0 pt-3"> <label for="animal_boarding_email">Email</label> <input type="text" name = "animal_boarding_email" class="bg-light form-control" placeholder="Email"> </div>
          </div>
