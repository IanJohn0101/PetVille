  ...
  <tbody id="table-body">
	...
	?>
	  <tr class="table-row">
		...
		<td><a class="ajax-action-links" href='edit.php?id=<?php echo $row['user_id']; ?>'><img src="crud-icon/edit.png" title="Edit" /></a> <a class="ajax-action-links" href='delete.php?id=<?php echo $row['id']; ?>'><img src="crud-icon/delete.png" title="Delete" /></a></td>
	  </tr>
    <?php
		}
	}
